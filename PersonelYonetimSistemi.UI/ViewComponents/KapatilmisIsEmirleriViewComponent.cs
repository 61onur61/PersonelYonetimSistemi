...
{
    public class KapatilmisIsEmirleriViewComponent : ViewComponent
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;

        public KapatilmisIsEmirleriViewComponent(IUnitOfWork unitOfWork, IMapper mapper)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var isEmriDurumu = (int)EnumIsEmriDurumlari.IsKapatildi;
