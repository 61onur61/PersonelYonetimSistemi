...
{
    public class UstlenilmisIsEmirleriViewComponent : ViewComponent
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;

        public UstlenilmisIsEmirleriViewComponent(IUnitOfWork unitOfWork, IMapper mapper)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var isEmriDurumu = (int)EnumIsEmriDurumlari.IsUstlenildi;
