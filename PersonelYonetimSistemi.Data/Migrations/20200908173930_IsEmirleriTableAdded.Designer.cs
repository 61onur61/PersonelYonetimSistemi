...
namespace PersonelYonetimSistemi.Data.Migrations
{
    ...
    [Migration("20200908173930_IsEmirleriTableAdded")]
    partial class IsEmirleriTableAdded
    {
            ...
            modelBuilder.Entity("PersonelYonetimSistemi.Data.Models.PersonelIsEmirleri", b =>
                {
                    ...
                    b.Property<int>("PersonelIsAtamaId")
                        .HasColumnType("int");

                    b.Property<string>("PersonelIsAtamaId1")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("Id");

                    b.HasIndex("PersonelIsAtamaId1");
            ...
            modelBuilder.Entity("PersonelYonetimSistemi.Data.Models.PersonelIsEmirleri", b =>
                {
                    b.HasOne("PersonelYonetimSistemi.Data.Models.Personels", "PersonelIsAtama")
                        .WithMany()
                        .HasForeignKey("PersonelIsAtamaId1");
                });
